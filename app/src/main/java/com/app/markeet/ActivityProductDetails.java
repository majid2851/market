...
import com.app.markeet.utils.JalaliCalendar;
...
public class ActivityProductDetails extends AppCompatActivity {
    ...
    private void displayPostData() {
        ...
        Content.setText(Html.fromHtml(product.description));
        JalaliCalendar JC = new JalaliCalendar();
        Date date = new Date(product.last_update);
        String Persaindate = JC.getJalaliDate(date);
        ((TextView) findViewById(R.id.date)).setText(Persaindate);
        ((TextView) findViewById(R.id.price)).setText(product.price + " " + getString(R.string.ircurrency));
