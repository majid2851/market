...
public class ActivityCheckout extends AppCompatActivity {
        ...
        ZarinPal.getPurchase(this).verificationPayment(data, new OnCallbackVerificationPaymentListener() {
            ...
            public void onCallbackResultVerificationPayment(boolean isPaymentSuccess, String refID, PaymentRequest paymentRequest) {
                if (isPaymentSuccess) {
                    ...
                    String message = "خرید شما موفق بود " + refID;
                    Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT).show();
                    delaySubmitOrderData();
                } else {
                    /* When Payment Request is Failure :) */
                    String message = "خرید شما نا موفق بود";
                    Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT).show();
                }
    ...
    private void requestPayment() {
        ...
        payment.setMerchantID("649ea96e-60d5-11e9-ae83-000c295eb8fc");
        payment.setAmount(_total_fees_);
        payment.setDescription("صورتحساب فروشگاه اینترنتی");
        payment.setCallbackURL("snapptoys://shopappgraphi");    /* Your App Scheme */
    ...
    private void setTotalPrice() {
        ...
        int _total_order_ =Integer.valueOf(_total_order.intValue());
        _price_tax = _total_order_ * info.tax / 100;
        _total_fees = _total_order_ + _price_tax;
        _total_fees_ = (int) (_total_order_ + _price_tax);
        ...
        // set to display
        total_order.setText(_total_order_ + " " + getString(R.string.ircurrency));
        tax.setText(getString(R.string.tax) + info.tax + "%");
        price_tax.setText(_price_tax + " " + getString(R.string.ircurrency));
        total_fees.setText(_total_fees + " " + getString(R.string.ircurrency));
    }
